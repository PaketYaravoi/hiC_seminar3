...
foreach (int i in inputNew)               // можно вложить resolt можно вложить inputNew, только не строку input) так как это строка а не мосивы данных как в случае с inputNew
{
    Console.Write(i + "; ");
}
